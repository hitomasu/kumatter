...
import org.leihauoli.kumatter.form.home.MyTweetForm;
 ...
 */
@Authentication
public class MyTweetAction {

	// アクションフォーム
	@Resource
	@ActionForm
	public MyTweetForm myTweetForm;
	...
	public String doTweetDelete() {
		...
		// ツイートを論理削除
		tweetService.deleteTweet(myTweetForm.tweetHistoryId, myTweetForm.versionNo);

		return "/home/myTweet?redirect=true";
	}
